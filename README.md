...
<p>In this project first take an random module and other main work that have only two players
are allowed to play this game. When user & computer have any one get 6 (six) the program stop
and waiting the other procesing.
When user/computer allows the other processing so take count 
the dices and only first have reached 10 scorethat this player
has won the game</p>
